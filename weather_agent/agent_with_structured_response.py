...
class MyOutputFormat(BaseModel):
    step: str = Field(..., description="The step type: START, PLAN, OUTPUT, TOOL")
    ...
    input: Optional[str] = Field(None, description="the input params for the tool to be called")
...
while True:
    ...
    while True:
        ...
        if parsed_response.step == "START":
            print("START: ", parsed_response.content)
            continue
            ...
            print("OUTPUT: ", parsed_response.content)
            break
    print("\n\n\n")